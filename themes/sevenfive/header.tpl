...
<link rel="stylesheet" href="{blogPath}/themes/sevenfive/css/style.css" type="text/css" media="screen, projection">
<link rel="stylesheet" href="{blogPath}/themes/sevenfive/css/style.css3.css" type="text/css" media="screen, projection">
