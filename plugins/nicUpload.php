...
$blogPath=dirname(dirname($serverName.$serverPort.$scriptName));

define('NICUPLOAD_PATH', '../data/'.$_SESSION['user'].'/pictures'); // Set the path (relative or absolute) to
                                      // the directory to save image files
if (!file_exists(NICUPLOAD_PATH)) { mkdir(NICUPLOAD_PATH,0755); }

define('NICUPLOAD_URI', $blogPath.'/data/'.$_SESSION['user'].'/pictures');   // Set the URL (relative or absolute) to

//echo NICUPLOAD_PATH.'  '.NICUPLOAD_URI.'<br>';
//die();
