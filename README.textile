...
h2. CHANGES FOR 0.82
* Improve user friendliness using jQuery javascript library.
* Protect from losing unsaved changes.
* Autosave posts when in edit mode.
...
If you are on Pritlog 0.811 or later, just overwrite all the files except your data folder ones.
