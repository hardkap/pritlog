...
class SecureSession
{
    var $check_browser = true; // Include browser name in fingerprint?
    var $check_ip_blocks = 0;  // How many numbers from IP use in fingerprint?
    var $secure_word = 'SECURESTAFF'; // Control word - any word you want.
    var $regenerate_id = true;  // Regenerate session ID to prevent fixation attacks?
